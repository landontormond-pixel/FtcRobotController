...
@Autonomous
public class BlueGoalPedro extends OpMode {
    DcMotorEx launch;
    DcMotor intake;
    CRServo intakeLeft;
    CRServo intakeRight;
    ...
    private final Pose startPose = new Pose(20.9651474530831, 121.98123324396782, Math.toRadians(136));
    private final Pose shootPose = new Pose(48.930294906166225, 94.80428954423591, Math.toRadians(136));
    private final Pose prepick1Pose = new Pose(60.2225201072386, 83.73190348525466, Math.toRadians(180));
    private final Pose pick1Pose = new Pose(14.772117962466487, 83.58445040214481, Math.toRadians(180));
    private final Pose prepick2Pose = new Pose(48.45040214477213, 59.88471849865951, Math.toRadians(180));
    private final Pose pick2Pose = new Pose(12.747989276139407, 59.82573726541554, Math.toRadians(180));
    private final Pose prepick3Pose = new Pose(48.707774798927616, 35.6461126005362, Math.toRadians(180));
    private final Pose pick3Pose = new Pose(12.879356568364607, 35.747989276139435, Math.toRadians(180));
    private final Pose endPose = new Pose(37.84986595174263, 72.5603217158177, Math.toRadians(180));
